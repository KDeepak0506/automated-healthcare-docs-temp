...
export default function AppLayout({ children }) {
  ...
  const getPageTitle = () => {
    ...
    if (location.pathname === "/documents") return "Healthcare Documents";
    if (location.pathname === "/upload") return "Upload Document";
    if (location.pathname === "/patients") return "Patient Directory";
    if (location.pathname.startsWith("/patients/")) return "Patient Workspace";
    return "HealthParse";
  };
